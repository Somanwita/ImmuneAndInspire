...
@Component
public class RequesterUpdateValidator implements Validator {
    ...
    public void validate(Object obj, Errors errors)
    {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "requestedvaccines", "error.invalid.userR", "Vaccine Name Required");
